...
?>
	...
	?>
	<ol>
		<?php if($this->fields[0]->published == 0){?><li>This field is <span style="color:red;">Not Published</span> in Jom Social Custom Profiles. Please Publish it.</li><?php }?>
		<?php if($this->fields[0]->required == 0){?><li>This field is set to <span style="color:red;">Not Required</span> in Jom Social Custom Profiles. Please make it Required.</li><?php }?>
		<?php if($this->fields[0]->visible == 0){?><li>This field is set to <span style="color:red;">Not Visible</span> for user in Jom Social Custom Profiles. Please make it Visible.</li><?php }?>
		<?php if($this->fields[0]->published == 1 
				&& $this->fields[0]->required == 1
				&& $this->fields[0]->visible == 1){
