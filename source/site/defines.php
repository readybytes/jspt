...
defined('XIPT_VERSION') or define('XIPT_VERSION','4.2.3');
...
if(!defined('REG_PROFILETYPE_AVATAR_HEIGHT')) define('REG_PROFILETYPE_AVATAR_HEIGHT',100);
	
if(!defined('REG_PROFILETYPE_AVATAR_WIDTH')) define('REG_PROFILETYPE_AVATAR_WIDTH',100);
...
define('PROFILETYPE_JS_DEFAULT_AVATAR_STORAGE_REFERENCE_PATH','images'.DS.'avatar');
define('PROFILETYPE_AVATAR_STORAGE_PATH', JPATH_ROOT .DS. PROFILETYPE_AVATAR_STORAGE_REFERENCE_PATH);
define('PROFILETYPE_JS_DEFAULT_AVATAR_STORAGE_PATH', JPATH_ROOT .DS. PROFILETYPE_JS_DEFAULT_AVATAR_STORAGE_REFERENCE_PATH);
...
define('PROFILETYPE_JSPT_DEFAULT_AVATAR_STORAGE_PATH', JPATH_ROOT.DS.'images'.DS.'jspt_default');
define('PROFILETYPE_JSPT_DEFAULT_AVATAR_STORAGE_REFERENCE_PATH', 'images'.DS.'jspt_default');
