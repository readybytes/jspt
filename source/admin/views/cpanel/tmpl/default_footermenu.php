...
<div class="span20" style="text-align:center; width:100%; border-top: solid #DDDDDD 1px; margin-top:20px; padding-top: 5px;">
	<div>
		<a href='http://www.readybytes.net/jomsocial-profile-type/downloads.html?downloads/jomsocial-multi-profile-types.html' target="_blank"><?php echo XiptText::_('DOWNLOAD');?></a>
		| <a href='http://www.readybytes.net/jomsocial-profile-type/forum.html' target="_blank"><?php echo XiptText::_('SUPPORT');?></a>
		...
		| <a href='http://www.readybytes.net/jomsocial-profile-type/documentation.html' target="_blank"><?php echo XiptText::_('DOCUMENTATION');?></a>
		| <a href='http://www.gnu.org/licenses/old-licenses/gpl-2.0.html' target="_blank"><?php echo XiptText::_('LICENSE');?></a>
		| <a href='http://twitter.com/readybytes' target="_blank"><?php echo XiptText::_('FOLLOW_TWITTER');?></a>
