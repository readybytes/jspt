...
class XiptpluginTest extends XiUnitTestCase
{
	...
	{
		$obj = new XiptSetupRuleXiptplugin();
		$this->assertEquals($obj->doApply(), 'COM_XIPT_PLUGINS_ENABLED_SUCCESSFULLYCOM_XIPT_CUSTOM_FIELD_ALREADY_CREATED_AND_ENABLED_SUCCESSFULLYCOM_XIPT_FILES_PATCHED_SUCCESSFULLY');
		//$this->_DBO->addTable('#__plugins');
	}
}