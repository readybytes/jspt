...
(84, '', 2, '0000-00-00 00:00:00', 'components/com_community/assets/default1.jpg', 'components/com_community/assets/default1_thumb.jpg', 0, 'notifyEmailSystem=1\nprivacyProfileView=20\nprivacyPhotoView=0\nprivacyFriendsView=0\nprivacyVideoView=1\nnotifyEmailMessage=1\nnotifyEmailApps=1\nnotifyWallComment=0\n\n', 0, 0),
...
TRUNCATE TABLE `au_#__community_users` ;; TRUNCATE TABLE `au_#__community_users`;;
