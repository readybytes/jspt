...
class JomsocialTest extends XiUnitTestCase 
{
  ...
  function testUpdateCommunityUserAvatar()
  {
  	...
  	$this->assertTrue(XiptLibJomsocial::updateCommunityUserAvatar(83, 'test/test/unit/front/images/avatar.jpg'));
  ...
  function testChangeAvatarOnSyncUp()
  {
  	...
  	JRequest::setVar('task','', 'REQUEST');
  	$this->assertFalse(XiptLibJomsocial::_changeAvatarOnSyncUp(''));
  	
  	/*//case #2: return true when task is syncUpUserPT
  	JRequest::setVar('task','syncUpUserPT', 'REQUEST');
  	$this->assertTrue(XiptLibJomsocial::_changeAvatarOnSyncUp('images/profiletype/avatar_2.gif'));*/
  	
  	//case #3: return false when task is syncUpUserPT but u 
  	JRequest::setVar('task','syncUpUserPT', 'REQUEST');
  	$this->assertFalse(XiptLibJomsocial::_changeAvatarOnSyncUp(''));
  }
