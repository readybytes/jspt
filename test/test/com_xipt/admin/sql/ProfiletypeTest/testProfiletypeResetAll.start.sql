...
(2, 'PROFILETYPE-2', 1, 1, 'PROFILETYPE-TWO-TIP', 'friends', 'blueface', 'Editor', 'images/profiletype/avatar_2.gif', 0, 0, 0, '', '', 'enableWaterMark=0\nxiText=Profiletype2\nxiWidth=160\nxiHeight=40\nxiThumbWidth=80\nxiThumbHeight=20\nxiFontName=monofont\nxiFontSize=26\nxiTextColor=FFFFFF\nxiBackgroundColor=9CD052\nxiWatermarkPosition=tl\ndemo=2\n\n'),
...
(1, 'PROFILETYPE-1', 2, 1, 'PROFILETYPE-ONE-TIP', 'public', 'default', 'Manager', 'components/com_community/assets/default.jpg', 0, 0, 1, '', '', 'enableWaterMark=0\nxiText=Profiletype1\nxiWidth=150\nxiHeight=30\nxiThumbWidth=80\nxiThumbHeight=20\nxiFontName=monofont\nxiFontSize=24\nxiTextColor=FFFFFF\nxiBackgroundColor=0F15D0\nxiWatermarkPosition=tr\ndemo=1\n\n'),
(2, 'PROFILETYPE-2', 1, 1, 'PROFILETYPE-TWO-TIP', 'public', 'default', 'Editor', 'images/profiletype/avatar_2.gif', 0, 0, 0, '', '', 'enableWaterMark=0\nxiText=Profiletype2\nxiWidth=160\nxiHeight=40\nxiThumbWidth=80\nxiThumbHeight=20\nxiFontName=monofont\nxiFontSize=26\nxiTextColor=FFFFFF\nxiBackgroundColor=9CD052\nxiWatermarkPosition=tl\ndemo=2\n\n'),
(3, 'PROFILETYPE-3', 3, 1, 'PROFILETYPE-THREE-TIP', 'members', 'blackout', 'Publisher', 'components/com_community/assets/default.jpg', 0, 0, 2, '', '', 'enableWaterMark=0\nxiText=Profiletype3\nxiWidth=100\nxiHeight=40\nxiThumbWidth=80\nxiThumbHeight=20\nxiFontName=monofont\nxiFontSize=18\nxiTextColor=FFFFFF\nxiBackgroundColor=0F15D0\nxiWatermarkPosition=rb\ndemo=3\n\n'),
(4, 'PROFILETYPE-4', 4, 0, 'PROFILETYPE-FOUR-TIP', 'members', 'blackout', 'Registered', 'components/com_community/assets/default.jpg', 0, 0, 0, '', '', 'enableWaterMark=0\nxiText=Profiletype4\nxiWidth=100\nxiHeight=40\nxiThumbWidth=80\nxiThumbHeight=20\nxiFontName=monofont\nxiFontSize=18\nxiTextColor=FFFFFF\nxiBackgroundColor=0F15D0\nxiWatermarkPosition=rb\ndemo=4\n\n');;
