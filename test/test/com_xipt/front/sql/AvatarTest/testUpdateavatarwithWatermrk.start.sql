...
(4, 'PROFILETYPE-4', 4, 1, 'PROFILETYPE-FOUR-TIP', 'members', 'default', 'Registered', 'components/com_community/assets/user.png', 0, 0, '0', 'images/profiletype/watermark_4.png', '', 'enableWaterMark=1\ntypeofwatermark=1\nxiText=P4\nxiWidth=32\nxiHeight=32\nxiThumbWidth=80\nxiThumbHeight=20\nxiFontName=monofont\nxiFontSize=26\nxiTextColor=FFFFFF\nxiBackgroundColor=3842D0\nxiWatermarkPosition=tl\ndemo=1\n\n', 1, '');;
